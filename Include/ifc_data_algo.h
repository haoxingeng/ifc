...
binary HashFile(HASH_TYPE nHashType, LPCTSTR lpszFileName, PVOID pDigest = NULL);
...
void EncryptFile(CIPHER_TYPE nCipherType, LPCTSTR lpszSrcFileName, LPCTSTR lpszDestFileName, char *lpszKey);
void DecryptFile(CIPHER_TYPE nCipherType, LPCTSTR lpszSrcFileName, LPCTSTR lpszDestFileName, char *lpszKey);
...
public:
	...
	binary CalcFile(LPCTSTR lpszFileName, FORMAT_TYPE nFormatType = FT_COPY, IDataAlgoProgress *pProgress = NULL);
...
protected:
	...
	void DoCodeFile(LPCTSTR lpszSrcFileName, LPCTSTR lpszDestFileName, int nBlockSize,
		CIPHER_KIND nCipherKind, IDataAlgoProgress *pProgress);
...
public:
	...
	void EncodeFile(LPCTSTR lpszSrcFileName, LPCTSTR lpszDestFileName, IDataAlgoProgress *pProgress = NULL);
	void DecodeFile(LPCTSTR lpszSrcFileName, LPCTSTR lpszDestFileName, IDataAlgoProgress *pProgress = NULL);
