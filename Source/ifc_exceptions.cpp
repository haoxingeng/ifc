...
CString CIfcFileException::GetErrorMessage() const
{
    ...
    switch (m_nCause)
    {
    case E_NONE:                strFmt = IEM_FILE_E_NONE;                break;
    case E_GENERIC:             strFmt = IEM_FILE_E_GENERIC;             break;
    case E_FILE_NOT_FOUND:      strFmt = IEM_FILE_E_FILE_NOT_FOUND;      break;
    case E_BAD_PATH:            strFmt = IEM_FILE_E_BAD_PATH;            break;
    case E_TOO_MANY_OPEN_FILES: strFmt = IEM_FILE_E_TOO_MANY_OPEN_FILES; break;
    case E_ACCESS_DENIED:       strFmt = IEM_FILE_E_ACCESS_DENIED;       break;
    case E_INVALID_FILE:        strFmt = IEM_FILE_E_INVALID_FILE;        break;
    case E_REMOVE_CURRENT_DIR:  strFmt = IEM_FILE_E_REMOVE_CURRENT_DIR;  break;
    case E_DIRECTORY_FULL:      strFmt = IEM_FILE_E_DIRECTORY_FULL;      break;
    case E_BAD_SEEK:            strFmt = IEM_FILE_E_BAD_SEEK;            break;
    case E_HARD_IO:             strFmt = IEM_FILE_E_HARD_IO;             break;
    case E_SHARING_VIOLATION:   strFmt = IEM_FILE_E_SHARING_VIOLATION;   break;
    case E_LOCK_VIOLATION:      strFmt = IEM_FILE_E_LOCK_VIOLATION;      break;
    case E_DISK_FULL:           strFmt = IEM_FILE_E_DISK_FULL;           break;
    case E_END_OF_FILE:         strFmt = IEM_FILE_E_END_OF_FILE;         break;
    }
